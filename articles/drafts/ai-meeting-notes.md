...
<p class="voice-comment">私もいくつかの議事録ツールを会議で試してみたのですが、いちばん差が出ると感じたのは日本語の文字起こし精度でした。英語向けに評判のよいツールでも、日本語の会議に使うと固有名詞の取りこぼしが増える印象です。個人的には、まず自分がよく使う会議ツールとの連携と日本語精度を優先して選ぶと、後から乗り換える手間が減ると感じています。</p>
</div>
</div>
